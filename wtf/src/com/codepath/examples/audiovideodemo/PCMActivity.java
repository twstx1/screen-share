	...
	class UIHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case CMD_RECORDING_TIME:
				...
				PCMActivity.this.txt.setText("正在录音中，已录制：" + vTime + " s");
				break;
			case CMD_RECORDFAIL:
				int vErrorCode = b.getInt("msg");
				String vMsg = ErrorCode.getErrorInfo(PCMActivity.this,
						vErrorCode);
				PCMActivity.this.txt.setText("录音失败：" + vMsg);
				break;
			case CMD_STOP:
				...
				case FLAG_WAV:
					...
					PCMActivity.this.txt.setText("录音已停止.录音文件:"
							+ AudioFileFunc.getWavFilePath() + "\n文件大小："
							+ mSize);
					break;
				case FLAG_AMR:
					PCMActivity mRecord_2 = PCMActivity.getInstance();
	...
	class UIThread implements Runnable {
		...
		public void run() {
			while (vRun) {
				...
				PCMActivity.this.uiHandler.sendMessage(msg); // 向Handler发送消息,更新UI
			}

		}
	}

	public static PCMActivity getInstance() {
		// TODO Auto-generated method stub
		return null;
	}
